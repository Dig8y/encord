...
export default function VisualDataManagmentComponent() {
  ...
  console.log("🚀 ~ VisualDataManagmentComponent ~ mouseX:", mouseX)
  const [mouseY, setMouseY] = useState(0)
  console.log("🚀 ~ VisualDataManagmentComponent ~ mouseY:", mouseY)
  console.log("🚀 ~ VisualDataManagmentComponent ~ mouseEntered:", mouseEntered)

  useEffect(() => {
    if (mouseEntered) {document.addEventListener("mousemove", (e) => {
      setMouseX(e.clientX)
      setMouseY(e.clientY)
    });}
  }, [mouseEntered])
  ...
  return (<div className="flex flex-col mx-auto my-6 lg:bg-white bg-[#FAFAFA] lg:flex-row rounded-3xl border overflow-hidden lg:p-0 p-5">
    <div className="lg:max-w-[370px] text-left text-gray-600 bg-[#FAFAFA]">
      <h2 className="text-xs tracking-widest_1 opacity-50 font-medium uppercase lg:p-5 lg:py-5 pb-2.5 py-1.5">
